...
package com.app.name.test;

import static com.app.name.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import com.app.name.core.News;
import com.app.name.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.app.name.ui.CarouselActivity}
     */
    public NewsViewTest() {
