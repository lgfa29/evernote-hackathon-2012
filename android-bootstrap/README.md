...
This repository contains the source code for the [app](http://www.androidbootstrap.com/)
Android app available soon from [Google Play](https://play.google.com/store/apps/details?id=com.app.name).



Please see the [issues](https://github.com.app.name/issues) section
to report any bugs or feature requests and to see the list of known issues.

<a href="https://play.google.com/store/apps/details?id=com.app.name" alt="Download from Google Play (soon)">
...
signed with a different key.  Manually uninstall app from your device and
you will then be able to install your own built version.

## Acknowledgements

app is a result of a template project I've developed over the years as well as
...
app is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.app.name/pulls).
